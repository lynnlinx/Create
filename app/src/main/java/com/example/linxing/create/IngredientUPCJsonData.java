...
class IngredientUPCJsonData extends AsyncTask<String, Void, List<Ingredient>> implements GetRawData.OnDownloadComplete {
    ...
    public IngredientUPCJsonData(OnDataAvailable callBack, String baseURL, boolean matchAll) {
        mBaseURL = baseURL;
        mMatchAll = matchAll;
        mCallBack = callBack;
    }
    ...
    private String createUri(String searchCriteria, boolean matchAll) {
        ...
        return Uri.parse(mBaseURL).buildUpon()
                .appendQueryParameter("upc", searchCriteria)
                .build().toString();
    }
    ...
    public void onDownloadComplete(String data, DownloadStatus status) {
        ...
        if (status == DownloadStatus.OK) {
            ...
            try {
                ...
                JSONArray itemsArray = jsonData.getJSONArray("foods");
